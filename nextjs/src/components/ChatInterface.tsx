  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex space-x-2 p-4 bg-gray-800">
        <textarea
          className="flex-1 px-4 py-2 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white resize-none"
